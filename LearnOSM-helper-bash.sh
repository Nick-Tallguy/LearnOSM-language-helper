...
sed -i s_glish]\(\/${lang}_glish]\(\/en_ $output_path/0200-12-29-introduction_interim_$lang.md
#
...
sed -i s_glish]\(\/${lang}_glish]\(\/en_ $output_path/0200-12-27-start-osm_interim_$lang.md
#
...
sed -i s_glish]\(\/${lang}_glish]\(\/en_ $output_path/0200-12-23-id-editor_interim_$lang.md
#
...
sed -i s_glish]\(\/${lang}_glish]\(\/en_ $output_path/0200-12-05-glossary_interim_$lang.md
#
...
sed -i s_glish]\(\/${lang}_glish]\(\/en_ $output_path/0200-12-03-moving-forward_interim_$lang.md
#
...
sed -i s_glish]\(\/${lang}_glish]\(\/en_ $output_path/0500-10-27-humanitarian_interim_$lang.md
#
...
sed -i s_glish]\(\/${lang}_glish]\(\/en_ $output_path/0500-12-31-coordination_interim_$lang.md
#
...
sed -i s_glish]\(\/${lang}_glish]\(\/en_ $output_path/0500-10-15-remote-tracing_interim_$lang.md
#
